...
def main():
    st.set_page_config(page_title="可拖拽数据大屏", page_icon="🌸", layout="wide")
    ...
    st.write("参考颜色：https://nivo.rocks/bar/")
    layout = [
        dashboard.Item("面积图", 0, 0, 5, 3),
        dashboard.Item("漏斗图", 6, 0, 7, 3),
    ...
    with elements("demo"):
        ...
        with dashboard.Grid(layout, draggableHandle=".draggable"):
            with mui.Card(key="曲线图",
                          sx={"color": 'white', 'bgcolor': 'success.main', "display": "flex", 'borderRadius': 2,
            ...
            with mui.Card(key="漏斗图",
                          sx={"color": 'white', 'bgcolor': 'success.main', 'borderRadius': 2, "display": "flex",
                              "flexDirection": "column"}):
